    ...
    return (
        <div>
            ...
            <div className="login-page-banner text-white">
                <PageTitle title="Conantc us for emergency services or Your Valuable Feedback"></PageTitle>
            </div>
                        ...
                        <div className=" p-8 m-auto">
                            ...
                            <form >
                                ...
                                <div className="text-center pt-4">
                                    <button className="rounded-full py-2 px-4 border text-blue-600 text-lg font-semibold border-blue-500 hover:bg-blue-500 hover:text-white transition duration-500 ease-in-out " >Send Message</button>
                                </div>
                            </form>
                        </div>
                    </div>
